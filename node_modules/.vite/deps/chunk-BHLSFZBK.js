...
true ? MenuList.propTypes = {
   ...
   * @default false
   */
  autoFocusItem: import_prop_types3.default.bool,
  /**
...
var _excluded8 = ["autoWidth", "children", "classes", "className", "defaultOpen", "displayEmpty", "IconComponent", "id", "input", "inputProps", "label", "labelId", "MenuProps", "multiple", "native", "onClose", "onOpen", "open", "renderValue", "SelectDisplayProps", "variant"];
...
var Select = React9.forwardRef(function Select2(inProps, ref) {
  const props = useThemeProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  const InputComponent = input || {
    standard: (0, import_jsx_runtime11.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime11.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime11.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  const inputComponentRef = useForkRef_default(ref, InputComponent.ref);
  return (0, import_jsx_runtime11.jsx)(React9.Fragment, {
    children: React9.cloneElement(InputComponent, _extends({
...
true ? Select.propTypes = {
   ...
   */
  IconComponent: import_prop_types8.default.elementType,
  /**
   ...
   */
  input: import_prop_types8.default.element,
  /**
   * [Attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#Attributes) applied to the `input` element.
   ...
   * @default false
   */
  native: import_prop_types8.default.bool,
  /**
   * Callback fired when a menu item is selected.
   *
   ...
   */
  value: import_prop_types8.default.oneOfType([import_prop_types8.default.oneOf([""]), import_prop_types8.default.any]),
  /**
   * The variant to use.
   * @default 'outlined'
   */
...
var _excluded9 = ["autoComplete", "autoFocus", "children", "className", "color", "defaultValue", "disabled", "error", "FormHelperTextProps", "fullWidth", "helperText", "id", "InputLabelProps", "inputProps", "InputProps", "inputRef", "label", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onFocus", "placeholder", "required", "rows", "select", "SelectProps", "type", "value", "variant"];
...
var TextField = React10.forwardRef(function TextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTextField"
  });
  ...
  const InputElement = (0, import_jsx_runtime12.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime13.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime12.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? (0, import_jsx_runtime12.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children
    })) : InputElement, helperText && (0, import_jsx_runtime12.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
true ? TextField.propTypes = {
   ...
   * @default false
   */
  select: import_prop_types9.default.bool,
  /**
   * Props applied to the [`Select`](/material-ui/api/select/) element.
   */
  SelectProps: import_prop_types9.default.object,
  /**
...
//# sourceMappingURL=chunk-BHLSFZBK.js.map
