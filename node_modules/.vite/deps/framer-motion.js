...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react18.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  config = { ...(0, import_react26.useContext)(MotionConfigContext), ...config };
...
function useAnimationFrame(callback) {
  ...
  const { isStatic } = (0, import_react37.useContext)(MotionConfigContext);
...
var AnimateSharedLayout = ({ children }) => {
  ...
  return (0, import_jsx_runtime11.jsx)(LayoutGroup, { id: useConstant(() => `asl-${id3++}`), children });
};
