...
function useModal(parameters) {
  ...
  const modal = React2.useRef({});
  const mountNodeRef = React2.useRef(null);
  const modalRef = React2.useRef(null);
  const handleRef = useForkRef(modalRef, rootRef);
  const [exited, setExited] = React2.useState(!open);
  ...
  const isTopModal = React2.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
//# sourceMappingURL=chunk-D63LMWV3.js.map
